...
os.system("title spider_www.zq12369.com.py")
...
def start_spider(city):
    ...
    if isRepeat[0][0] == 0:
        try:
            ...
            # mongodb 数据备份
            x = {"Time_Point":Time_Point,"City_Name":City_Name,"AQI":AQI,"AQI_Rank":AQI_Rank,"Quality":Quality,"Primary_Pollutant":Primary_Pollutant,"PM2_5":PM2_5,"PM10":PM10,"SO2":SO2,"NO2":NO2,"CO":CO,"O3":O3,"Weather":Weather,"Temperature":Temperature,"Somatosensory_Temperature":Somatosensory_Temperature,"Humidity":Humidity,"Wind_Direction":Wind_Direction,"Wind_Speed":Wind_Speed,"Visibility":Visibility}
            db.NationalControlCityAQIWeather_zq12369.insert_one(x).inserted_id
        except Exception as e:
            print("执行异常SQL：" + sql)
