...
def download_page(url):
    return requests.post(url,proxies=proxies,cookies=cookies,headers={
...
def main():
    ...
    json_provices = [{"code":"ABJ","name":"北京市","url":"/publish/forecast/ABJ.html"}] #download_page("http://www.nmc.cn/f/rest/province").json()
